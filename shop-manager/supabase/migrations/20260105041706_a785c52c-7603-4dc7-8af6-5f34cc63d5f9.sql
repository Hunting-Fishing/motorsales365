-- Fix the create_workspace function to use correct column names
...
BEGIN
  ...
  -- Create organization (no created_by column exists)
  ...
  INSERT INTO user_roles (user_id, role, shop_id)
  VALUES (v_user_id, 'owner', v_shop_id)
