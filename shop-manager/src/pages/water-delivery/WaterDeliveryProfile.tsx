...
import { Loader2, User, Shield, Mail, Key, LogOut, Save, ArrowLeft, Droplets } from 'lucide-react';
import { ChangePasswordDialog } from '@/components/profile/ChangePasswordDialog';
import { ChangeEmailDialog } from '@/components/profile/ChangeEmailDialog';

export default function WaterDeliveryProfile() {
    ...
    <div className="p-6 space-y-6 max-w-4xl mx-auto">
      ...
      <Card>
        ...
        <CardContent className="space-y-4">
          ...
          <Button onClick={handleSaveProfile} disabled={isSaving} className="bg-cyan-500 hover:bg-cyan-600">
            {isSaving ? (
      ...
      <Card>
        ...
        <CardContent>
          <div className="inline-flex items-center gap-2 px-3 py-1 rounded-full bg-cyan-100 dark:bg-cyan-900/30 text-cyan-700 dark:text-cyan-300">
