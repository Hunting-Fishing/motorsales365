...
export function ExportLayout({ children }: ExportLayoutProps) {
  ...
  return (
    <div className="min-h-screen bg-background flex w-full">
      ...
      <div className={cn(
        ...
        <ExportSidebar collapsed={isMobile ? false : collapsed} onToggle={toggleSidebar} />
      </div>
      <div className={cn(
        ...
        <ExportHeader onMenuToggle={toggleSidebar} />
