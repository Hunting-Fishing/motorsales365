...
const BusinessApproved = ({ name, business_name, business_slug }: Props) => (
  <Html lang="en">
    <Head />
    <Preview>
      Your business "{business_name ?? "your business"}" is now live on {SITE_NAME}.
    </Preview>
    <Body style={main}>
      <Container style={container}>
        ...
        <Text style={text}>
          Your business page on {SITE_NAME} has been approved and is now visible to buyers and
          sellers nationwide.
        </Text>
        <Section style={card}>
...
export const template = {
  ...
  subject: ({ business_name }: Props) =>
    `🎉 "${business_name ?? "Your business"}" is now live on ${SITE_NAME}`,
