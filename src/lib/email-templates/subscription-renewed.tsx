...
interface Props { name?: string; amountPhp?: number; plan?: string; periodEnd?: string }
  ...
  <Html lang="en">
    ...
    <Body style={main}>
      <Container style={container}>
        ...
        <Text style={text}>{name ? `Hi ${name}, your` : "Your"} {SITE_NAME} subscription has been renewed successfully.</Text>
        <Section style={card}>
...
export const template = {
  ...
  previewData: { name: "Juan", amountPhp: 999, plan: "Dealer Pro — Monthly", periodEnd: "June 10, 2026" },
