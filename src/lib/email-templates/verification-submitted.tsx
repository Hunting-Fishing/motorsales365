...
interface Props { name?: string; legal_name?: string; business_kind?: string }
    ...
    <Body style={main}>
      <Container style={container}>
        ...
        <Section style={card}>
          ...
          {business_kind && <Text style={muted}>Business type: {business_kind.replace(/_/g, " ")}</Text>}
          <Text style={muted}>Status: Under review</Text>
        </Section>
        <Text style={text}>
          You can check status any time at <Link href={`${SITE_URL}/dashboard/verification`}>Verification</Link>.
        </Text>
...
export const template = {
  ...
  previewData: { name: "Juan", legal_name: "Quezon City Auto Repair Inc.", business_kind: "repair_shop" },
