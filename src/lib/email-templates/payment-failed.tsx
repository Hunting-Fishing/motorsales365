  ...
  <Html lang="en">
    ...
    <Body style={main}>
      <Container style={container}>
        ...
        <Text style={text}>
          {name ? `Hi ${name}, we` : "We"} tried to charge your payment method but it didn't go
          through.
        </Text>
        <Section style={card}>
        ...
        <Text style={text}>
          Please update your payment method to keep your listing or subscription active.
        </Text>
        <Section style={{ margin: "24px 0" }}>
          <Button href={`${SITE_URL}/dashboard/billing`} style={button}>
