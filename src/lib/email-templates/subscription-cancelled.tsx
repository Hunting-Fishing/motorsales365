...
interface Props { name?: string; plan?: string; periodEnd?: string }
  ...
  <Html lang="en">
    ...
    <Body style={main}>
      <Container style={container}>
        ...
        <Text style={text}>{name ? `Hi ${name}, we've` : "We've"} cancelled your {SITE_NAME} subscription as requested.</Text>
        <Section style={card}>
        ...
        <Text style={text}>Changed your mind? You can reactivate anytime before the period ends.</Text>
