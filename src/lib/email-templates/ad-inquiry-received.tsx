  ...
  <Html lang="en">
    ...
    <Body style={main}>
      <Container style={container}>
        ...
        <Text style={text}>
          We received your advertising inquiry
          {placement ? ` for ${placement.replace(/_/g, " ")}` : ""}. Our partnerships team will
          reply within 1–2 business days with a tailored proposal.
        </Text>
        <Text style={text}>
          In the meantime, feel free to reply to this email with any extra context — creatives,
          campaign goals, or target regions — and we'll factor it in.
        </Text>
        <Text style={footer}>
