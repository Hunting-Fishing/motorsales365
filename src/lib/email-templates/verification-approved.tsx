  ...
  <Html lang="en">
    ...
    <Body style={main}>
      <Container style={container}>
        ...
        <Text style={text}>
          Your business credentials have been approved. A <strong>Verified</strong> badge now
          appears next to your listings and seller profile, giving buyers extra confidence in your
          business.
        </Text>
        <Section style={card}>
        ...
        <Section style={{ textAlign: "center", margin: "24px 0" }}>
          <Button href={`${SITE_URL}/dashboard/profile`} style={button}>
            View my profile
          </Button>
        </Section>
        <Text style={footer}>
