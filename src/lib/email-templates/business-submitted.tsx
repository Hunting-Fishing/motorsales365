...
const BusinessSubmitted = ({ name, business_name, status }: Props) => (
  <Html lang="en">
    <Head />
    <Preview>
      We received your business submission "{business_name ?? "your business"}" on {SITE_NAME}.
    </Preview>
    <Body style={main}>
      <Container style={container}>
        ...
        <Text style={text}>
          Your submission is in our review queue. We typically respond within 1–2 business days and
          will email you again as soon as your page goes live.
        </Text>
        <Section style={card}>
...
export const template = {
  ...
  subject: ({ business_name }: Props) =>
    `"${business_name ?? "Your business"}" is under review on ${SITE_NAME}`,
