...
const BusinessRestored = ({ name, business_name, business_slug }: Props) => (
  <Html lang="en">
    <Head />
    <Preview>Your business {business_name ?? "your business"} is live again on {SITE_NAME}.</Preview>
    <Body style={main}>
      <Container style={container}>
        ...
        <Text style={text}>
          ...
          {business_slug ? <>: <Link href={`https://365motorsales.com/businesses/${business_slug}`}>View it here</Link></> : null}.
        </Text>
