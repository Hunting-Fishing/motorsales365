...
export const ADMIN_NAV: AdminNavItem[] = [
  ...
  { to: "/admin/document-check", label: "Document Check", Icon: Globe, roles: ["admin"], info: "Per-country vehicle transfer, import/export, insurance and document reference.", section: "Operations" },
