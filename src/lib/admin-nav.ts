...
export const ADMIN_NAV: AdminNavItem[] = [
  ...
  },
  {
    ...
    Icon: Inbox,
    roles: ["admin", "sales", "support"],
    info: "Leads submitted from the QR scan landing page form.",
    section: "Sales & Advertising",
  },
  {
  ...
  {
    to: "/admin/associate-applications",
    label: "Associate approvals",
    Icon: Handshake,
    roles: ["admin"],
    info: "Review business-linked 365 Associate applications and control the gold-ring network identity.",
    section: "Businesses",
  },
  {
  ...
  {
    to: "/admin/franchise",
    label: "Franchise queue",
    Icon: Handshake,
    roles: ["admin"],
    info: "Review franchise applications, assign tiers, and approve in bulk.",
    section: "Businesses",
  },
  {
  ...
  },
  {
    ...
    Icon: ShieldCheck,
    roles: ["admin", "moderator"],
    info: "Review club applications and accreditation documents.",
    section: "Businesses",
  },
  {
    to: "/admin/club-discount",
    label: "Club discount",
    Icon: BadgePercent,
    roles: ["admin"],
    info: "Configure the club-member discount %, eligible club statuses, and Stripe coupon behavior.",
    section: "Businesses",
  },
  {
    to: "/admin/discount-audits",
    label: "Discount audits",
    Icon: BadgePercent,
    roles: ["admin"],
    info: "Every club-member discount applied — by user, club, purchase type, and date.",
    section: "Businesses",
  },
  ...
  {
    to: "/admin/parts/outreach",
    label: "Parts Outreach",
    Icon: Store,
    roles: ["admin", "sales"],
    info: "CRM-style call queue for onboarding parts suppliers.",
    section: "Operations",
  },
  {
    to: "/admin/parts/feeds",
    label: "Product Feeds",
    Icon: Store,
    roles: ["admin"],
    info: "Auto-pull Lazada/Shopee/AliExpress product catalogs (Involve Asia datafeed).",
    section: "Operations",
  },
  {
    to: "/admin/dispatch",
  ...
  {
    to: "/admin/flashcards",
    label: "Flashcards content",
    Icon: Sparkles,
    roles: ["admin", "moderator"],
    info: "Pull the latest 365 Flashcards decks from the upstream GitHub repo.",
    section: "Operations",
  },
  {
    to: "/admin/document-check",
    label: "Document Check",
    Icon: Globe,
    roles: ["admin"],
    info: "Per-country vehicle transfer, import/export, insurance and document reference.",
    section: "Operations",
  },
  {
    to: "/admin/staff-academy",
    label: "Staff Academy",
    Icon: GraduationCap,
    roles: ["admin"],
    info: "Create, edit, reorder and publish internal staff training articles.",
    section: "Operations",
  },
  {
    to: "/admin/staff-academy/assets",
    label: "Academy Assets",
    Icon: GraduationCap,
    roles: ["admin"],
    info: "Upload infographics, scripts, images and videos for the Staff Academy.",
    section: "Operations",
  },
  ...
  {
    to: "/admin/signup-failures",
    label: "Signup failures",
    Icon: AlertTriangle,
    roles: ["admin"],
    info: "Recent signup_failure_events with reason/status/time filters.",
    section: "Platform",
  },
  {
  ...
  },
  {
    ...
    Icon: ShieldCheck,
    roles: ["admin"],
    info: "Inspect roles and permissions for any user.",
    section: "Platform",
  },
  {
    ...
    Icon: ShieldCheck,
    roles: ["admin"],
    info: "Toggle specific permissions per role without redeploying.",
    section: "Platform",
  },
  {
    to: "/admin/cron-tokens",
    label: "Cron tokens & keys",
    Icon: KeyRound,
    roles: ["admin"],
    info: "Rotate internal cron tokens and webhook signing keys.",
    section: "Platform",
  },
  {
    to: "/admin/sandbox",
