            ...
            <div className="flex items-start gap-3">
              ...
              <div>
                ...
                <p className="mt-1 text-muted-foreground">
                  You can fill in the form below, but you'll need a 365 account to submit it.
                  Promoter places are limited and subject to review.
                </p>
                <div className="mt-3 flex flex-wrap gap-2">
                  <Button asChild size="sm">
                    <Link to="/login" search={{ redirect: "/partner-program" }}>
                      Sign in
                    </Link>
                  </Button>
                  <Button asChild variant="outline" size="sm">
                    <Link to="/signup" search={{ redirect: "/partner-program", type: "buyer" }}>
                      Create account
                    </Link>
                  </Button>
                </div>
          ...
          <form onSubmit={onSubmit} className="space-y-6">
            ...
            {user ? (
              ...
              <div className="rounded-md border border-border bg-secondary/30 p-4 text-center">
                <p className="text-sm font-medium">Sign in to finish your application</p>
