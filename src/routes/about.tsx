...
export const Route = createFileRoute("/about")({
  head: () => ({
    meta: [
      { title: "About — AutoTrader Philippines" },
      { name: "description", content: "AutoTrader Philippines is the trusted marketplace for vehicles, equipment, and transport across the country." },
    ],
  }),
  component: () => (
    <SiteLayout>
      <div className="container mx-auto max-w-3xl px-4 py-16">
        <h1 className="font-display text-4xl font-bold">About AutoTrader Philippines</h1>
