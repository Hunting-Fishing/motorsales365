...
const NAV: NavItem[] = [
  ...
  },
  {
    ...
    info: "Inbound advertiser inquiries, leads and advertiser CRM.",
    section: "Sales",
  },
  {
    ...
    info: "Create, schedule and manage sponsored ad placements.",
    section: "Sales",
  },
  {
    to: "/admin/promotions",
    ...
    Icon: Ticket,
    roles: ["admin", "sales"],
    info: "Site-wide promo codes plus one-off discounts.",
    section: "Sales",
  },
  {
    to: "/admin/shop",
