...
const NAV: { to: string; label: string; Icon: any; exact?: boolean; roles: Role[]; info: string }[] = [
  ...
  { to: "/admin/type-suggestions", label: "Type suggestions", Icon: Sparkles, roles: ["admin"], info: "Review user-submitted new business types: approve, merge, or reject." },
  ...
  { to: "/admin/inquiries", label: "Service inquiries", Icon: Inbox, roles: ["admin","sales","support"], info: "Lead-gen inbox: financing, insurance, OR/CR, title transfer, inspection, towing requests from listing pages." },
