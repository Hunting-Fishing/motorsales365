...
export const Route = createFileRoute("/partner-program/info")({
  head: () => ({
    meta: [
      { title: TITLE },
        ...
        <div className="container relative mx-auto px-4 py-14 md:py-24">
          <div className="max-w-3xl">
            ...
            <div className="mt-8 flex flex-wrap gap-3">
              ...
              >
                <Link to="/partner-program" aria-label="Apply to become a 365 Motor Sales partner" onClick={() => trackCta("apply", { meta: { location: "hero" } })}>Apply to become a Partner</Link>
              </Button>
              <Button
                asChild
                size="lg"
        ...
        <div className="container mx-auto px-4 py-12 text-center">
          ...
          <div className="mt-6 flex flex-wrap justify-center gap-3">
            <Button asChild size="lg">
              <Link to="/partner-program" onClick={() => trackCta("apply", { meta: { location: "footer" } })}>Apply now</Link>
            </Button>
