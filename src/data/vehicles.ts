...
export const CAR_MAKES: MakeModels[] = [
  // ---------- Japanese ----------
  {
    make: "Toyota",
    models: [
      "Vios", "Wigo", "Yaris", "Yaris Cross", "Corolla", "Corolla Altis", "Corolla Cross", "Corolla Hatchback",
      "Camry", "Avanza", "Veloz", "Rush", "Innova", "Innova Zenix", "Zenix", "Fortuner", "Fortuner GR-S",
      "Land Cruiser", "Land Cruiser 70", "Land Cruiser 200", "Land Cruiser 300", "Land Cruiser Prado",
      "Hilux", "Hilux GR-S", "Hiace", "Hiace Commuter", "Hiace Super Grandia", "Hiace GL Grandia",
      "Tamaraw", "Tamaraw FX", "Revo", "Revo VX", "FJ Cruiser", "RAV4", "GR Yaris", "GR Supra", "GR86", "86",
      "Alphard", "Vellfire", "Lite Ace", "Coaster", "Prius", "Prius C", "Prius V", "bZ4X", "bZ3",
      "Crown", "Crown Sport", "Century", "Sienna", "Tundra", "Tacoma", "Sequoia", "4Runner", "Highlander",
      "Mark X", "Mark II", "Cressida", "Starlet", "Echo", "Soluna", "Probox", "Succeed", "Granvia",
      "MR2", "MR-S", "Celica", "Supra", "Sera", "Estima", "Previa", "Noah", "Voxy", "Esquire",
      "Raize", "Urban Cruiser", "Hilux Surf", "Land Cruiser FJ40", "Land Cruiser FJ60", "Land Cruiser FJ80",
    ],
  },
  {
    make: "Honda",
