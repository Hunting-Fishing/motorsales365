...
export const CAR_MAKES: MakeModels[] = [
  ...
  { make: "MG", models: [
    ...
    "ZS", "ZS EV", "HS", "HS PHEV", "RX5", "RX8", "RX9", "GS", "GT", "Cyberster", "Marvel R", "ES", "ES5", "EHS", "One",
  ] },
  { make: "Geely", models: [
    "Coolray", "Azkarra", "Okavango", "Emgrand", "Emgrand GS", "Emgrand X7", "Atlas", "Atlas Pro", "Atlas 8",
    "Geometry C", "Geometry G6", "Geometry M6", "Starray", "Starray EM-i", "GX3", "GX3 Pro", "EX5",
    "Monjaro", "Tugella", "Boyue", "Preface", "Galaxy E5", "Galaxy E8", "Galaxy L7", "Galaxy Starship 7", "Panda Mini",
  ] },
  { make: "Chery", models: [
    "Tiggo 2", "Tiggo 2 Pro", "Tiggo 4", "Tiggo 4 Pro", "Tiggo 5x", "Tiggo 7", "Tiggo 7 Pro", "Tiggo 7 Pro Max",
    "Tiggo 8", "Tiggo 8 Pro", "Tiggo 8 Pro Max", "Tiggo 9", "Tiggo 9 PHEV", "Tiggo Cross",
    "Arrizo 5", "Arrizo 6", "Arrizo 8", "Arrizo 8 Hybrid", "QQ", "Fulwin", "iCar 03", "iCar V23",
  ] },
