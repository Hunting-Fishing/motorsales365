...
import { Sheet, SheetContent, SheetHeader, SheetTitle } from '@sm/components/ui/sheet';
...
import { JobSafetyAnalysis, useJobSafetyAnalyses, useJSAHazards, JSAHazard } from '@sm/hooks/useJobSafetyAnalysis';
