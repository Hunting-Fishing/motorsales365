...
import { IncidentMetrics } from '@sm/hooks/useSafetyReports';
import { Tooltip as UITooltip, TooltipContent, TooltipProvider, TooltipTrigger } from '@sm/components/ui/tooltip';
