...
import { getCustomerProfile } from '@sm/services/customerProfileService';
import { getLoyaltyPoints } from '@sm/services/loyaltyService';
import { CustomerProfile, LoyaltyPoints } from '@sm/types/phase3';
