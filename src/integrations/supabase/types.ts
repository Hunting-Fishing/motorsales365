Warning: truncated output (original token count: 116173)
Total output lines: 14970
  ...
  public: {
    Tables: {
      ...
      ad_creative_audit_log: {
        Row: {
          ...
          previous_status: Database["public"]["Enums"]["ad_creative_status"] | null;
          reason: string | null;
        };
        Insert: {
          action: string;
        ...
        Relationships: [
          {
            ...
            columns: ["listing_id"];
            isOneToOne: false;
            referencedRelation: …16173 tokens truncated…          account_ref?: string | null;
          address?: string | null;
    ...
    Views: {
      ...
      public_listing_verification_status: {
        Row: {
          created_at: string | null;
          listing_id: string | null;
          status: Database["public"]["Enums"]["listing_verification_status"] | null;
          updated_at: string | null;
        };
        Relationships: [
          {
    ...
    Enums: {
      ...
      business_asset_kind:
        ...
        | "equipment"
        | "other";
      business_asset_status: "active" | "maintenance" | "out_of_service" | "retired";
      business_kind:
        | "repair_shop"
        | "insurance"
        | "dealership"
      ...
      lead_activity_kind: "created" | "assigned" | "status_changed" | "note" | "reply_sent";
      lead_source: "listing_message" | "business_inquiry" | "service_inquiry" | "tow_request";
      ...
      listing_registration_status: "registered" | "unregistered" | "for_transfer" | "unknown";
      listing_status:
        | "draft"
        | "pending_payment"
        | "active"
      ...
      passport_verification_status: "pending" | "more_info" | "approved" | "rejected";
      ...
      service_inquiry_status: "new" | "contacted" | "quoted" | "won" | "lost" | "spam";
      ...
      staff_contact_audit_action:
        ...
        | "expired"
        | "accessed";
      staff_contact_request_status: "pending" | "approved" | "denied" | "expired" | "revoked";
      verification_request_status: "pending" | "approved" | "rejected" | "more_info";
...
export const Constants = {
  public: {
    Enums: {
      ...
      listing_verification_status: ["unverified", "pending", "lto_verified", "mismatch", "expired"],
      lto_doc_type: ["cr", "or"],
      media_type: ["photo", "video"],
      org_role: ["owner", "admin", "member"],
      partner_tier: ["featured", "standard"],
